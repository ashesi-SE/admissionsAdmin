...
<img src="img\ad1.png" class="img-rounded" width="300" height="350" >
   <b><i>Applicants for admission</i></b>
</div></center>
...
<br>
        ...
        <div class="span8">
          ...
          <h1><center><i> View of Admissions Table </i></center></h1>
        <br><br>
...
//echo "<th class='defaultTitle'>ADMISSIONS ID</th>";
...
$query=$db->sql_query("select * from admissions ORDER BY admission_id");
