...
$season_id=$_POST['contact_id'];

$db = new admission();
$db->connect();

$query=$db->sql_query("SELECT * FROM seasons WHERE season_id='$season_id'");

if(mysql_num_rows($query) > 0){
$name=mysql_result($query,0,"name");
$year=mysql_result($query,0,"year");
$round=mysql_result($query,0,"round");
$open_date=mysql_result($query,0,"open_date");
$close_date=mysql_result($query,0,"close_date");
$description=mysql_result($query,0,"description");
$status=mysql_result($query,0,"status");
$creator=mysql_result($query,0,"creator");
$created=mysql_result($query,0,"created");
$modified=mysql_result($query,0,"modified");
    }
}
...
<center><div>
<br><br><br><br><br>            
<img src="img\ad5.jpg" class="img-rounded" width="450" height="490" ><br><br>
<b><i>Update Season</i></b>
</div></center>
...
<br>
        ...
        <div class="span8">
          ...
          <h1><center><i>Update season</i></center></h1>
...
<form action="UPDATE_SEASON.php" method="POST">

<center><div>

         <b><div class="controls">                    SEASON_ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="season_id" id="season_id" value="<?php echo $season_id; ?>" >
          </div><b>
      
       
        <b><div class="controls">
               SEASON NAME &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name" id="name"  value="<?php echo $name; ?>" >  
          </div><b>
    
    
        <b><div class="controls">
              YEAR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date"     name="year" id="year"  value="<?php echo $year; ?>">    
      </div><b>
       ...
       <b><div class="controls">
                ROUND&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="round"  id="round"  value="<?php echo $round; ?>">    
      </div><b>
                                                                                     
 
       <b><div class="controls">
                OPEN DATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="open_date"  id="open_date"  value="<?php echo $open_date; ?>">    
      </div><b>
      
      
      
            <b><div class="controls">
                CLOSE DATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="close_date"  id="close_date"  value="<?php echo $close_date; ?>">    
      </div><b>
      
      
      
            <b><div class="controls">               DESCRIPTION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
<textarea class="form-control" name="description"  id="description"  rows="3"  value="<?php echo $description; ?>"></textarea>     
     ...
     <div class="controls">STATUS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <select id="status" name="status" onClick="getSelectedItem()"  value="<?php echo $status; ?>">
        ...
        <option value="DELETED">DELETED</option>
            ...
            <b><div class="controls">
                CREATOR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="creator"  id="creator" value="<?php echo $creator; ?>">    
      </div><b>
      
      
      
            <b><div class="controls">
                CREATED&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="created"  id="created" value="<?php echo $created; ?>">    
      </div><b>
                                                    
                                                    
                                                    
               <b><div class="controls">
                MODIFIED&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="modified"  id="modified" value="<?php echo $modified; ?>">    
      </div><b>                                                 
...
<input type="submit" name="update_season" class="btn btn-primary btn-large" value="UPDATE SEASON" /> 
 </div></center>
