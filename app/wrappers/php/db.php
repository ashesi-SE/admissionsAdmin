...
function insert_APPLICANTS(){  
 ...
 $str_query="select applicant_id,application_id,first_names,middle_names,last_names,dob,gender,citizenship_primary,citizenship_secondary,passport_primary,passport_primary_expiration,passport_secondary,passport_secondary_expiration,phone_primary,phone_secondary,email_primary,email_secondary,street_address,city,region,country,postal_address,lives_with,picture_url,creator,created,modified from applicants";
 //if(!$this->sql_query($str_query)){
 //return false;
// }
// return true;
...
function insert_APPLICATION(){  
 ...
 $str_query="select * from applications ORDER BY application_id";
 //if(!$this->sql_query($str_query)){
 //return false;
// }
// return true;
